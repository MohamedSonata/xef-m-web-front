...

  {
    ...
    items: [
      ...
      { 
        ...
        href: '/documentation/file-transfer',
  ...
  return (
    ...
    <div className="relative min-h-screen bg-[var(--background)]">
      ...
      <button
        ...
        className="fixed top-24 left-4 z-40 lg:hidden bg-[var(--background-darker)] p-2 rounded-lg shadow-lg"
      ...
      <div className="flex pt-20">
        ...
        <div className={cn(
          ...
          "w-72 bg-[var(--background-darker)] border-r border-white/10",
          ...
          <div className="sticky top-0 bg-[var(--background-darker)]/50 backdrop-blur-sm z-10 p-4 border-b border-white/10">
